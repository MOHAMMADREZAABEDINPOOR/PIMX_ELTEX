...
export async function POST(request: Request) {
  ...
  if (!valid) return Response.json({ message: "The code is invalid or has expired.", errors: { code: "That code does not match. Check the latest email and try again." } }, { status: 400 });
